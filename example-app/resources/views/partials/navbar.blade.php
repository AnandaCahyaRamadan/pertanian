  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <img src="{{ asset ('/image/kementan.png') }}" class="user-image img-circle elevation-2" alt="User Image">
        <span class="d-none d-md-inline text-white">{{ Auth::user()->name }}</span>
      </a>
      <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <li class="user-header " style="height: 100px;">
          <img src="{{ asset ('/image/kementan.png') }}" style="height: 40px; width:40px" class="img-circle elevation-2" alt="User Image">
          <p>{{ Auth::user()->name }}</p>
        </li>
