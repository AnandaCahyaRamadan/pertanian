...
<section class="py-5" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-bottom: 1px solid #bbf7d0;">
    <div class="container text-center">
        <span class="section-badge"><i class="bi bi-shield-check"></i> Integritas & Akuntabilitas</span>
        <h1 class="fw-bold text-dark mt-2 mb-2">LHKPN - LHKASN</h1>
        <p class="text-muted mx-auto" style="max-width: 650px;">
            Laporan Harta Kekayaan Penyelenggara Negara (LHKPN) dan Laporan Harta Kekayaan Aparatur Sipil Negara (LHKASN) BBPP Binuang.
        </p>
    </div>
</section>

<section id="program-anggaran" class="py-5 bg-white">
    <div class="container">
        ...
        <div class="mb-5" data-aos="fade-up">
            ...
            <div class="d-flex align-items-center justify-content-between p-3 rounded-top-4 text-white shadow-sm" style="background: linear-gradient(90deg, #064e3b 0%, #15803d 100%);">
                ...
                <span class="badge bg-white text-success rounded-pill px-3 py-1 fw-bold small">
                    {{ $items->where('jenis_program_anggaran_id', 7)->count() }} Dokumen
                </span>
            </div>
