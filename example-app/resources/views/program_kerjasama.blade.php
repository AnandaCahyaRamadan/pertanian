...
<section class="py-5" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-bottom: 1px solid #bbf7d0;">
    <div class="container text-center">
        <span class="section-badge"><i class="bi bi-folder-check"></i> Transparansi Informasi</span>
        <h1 class="fw-bold text-dark mt-2 mb-2">Informasi Program & Kinerja</h1>
        <p class="text-muted mx-auto" style="max-width: 600px;">
            Dokumen resmi perencanaan, program kerja, laporan akuntabilitas, dan kinerja BBPP Binuang.
        </p>
    </div>
</section>
